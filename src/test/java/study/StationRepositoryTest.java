...
class StationRepositoryTest {
    ...
    @Autowired
    private Station2Repository notAutoGeneratedStations;
    ...
    class SaveWithoutGeneratedValueTest {
        ...
        void GeneratedValue_어노테이션_없이_엔티티의_식별자_직접_저장시_INSERT문은_쓰기_지연_저장소에_관리되지만_SELECT문으로_해당_식별자의_엔티티_존재여부를_사전에_확인함() {
            ...
            notAutoGeneratedStations.save(new Station2(1000L, "잠실역"));
            notAutoGeneratedStations.save(new Station2(1001L, "선릉역"));
            // INSERT 쿼리 미전송
            System.out.println("####################");
